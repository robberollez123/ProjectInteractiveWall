...
void InitTimer6(void)
{
	...
	TIM6->CR1 |= TIM_CR1_CEN;						// Counter enable. Steeds inschakelen. Ook als je pas later de interrupts wil opvangen.
...
//  //	TIM6->EGR |= TIM_EGR_UG;						// Registers updaten (enkel uitzonderlijke gevallen). In one pulse mode zorgt dit voor het uitzetten van CEN.
