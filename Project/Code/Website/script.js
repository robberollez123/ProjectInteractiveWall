...
const dataTable = document.getElementById('dataTable').getElementsByTagName('tbody')[0]; // Reference to the table's body
...
document.addEventListener("DOMContentLoaded", async () => {
    await attemptAutoConnect(); // Try auto-connecting when the page is loaded
});
